  ...
  <form action="{$urls.pages.password}" class="forgotten-password" method="post">
    ...
    <section class="form-fields">
      <div class="form-group center-email-fields row">
        <label class="col-lg-4 col-md-5 col-12 form-control-label required">{l s='Email address' d='Shop.Forms.Labels'}</label>
        ...
        <button class="form-control-submit btn btn-primary md-12 d-none d-md-block" name="submit" type="submit">
